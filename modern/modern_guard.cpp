...
modern_guard::modern_guard(struct modern_class* const object) modern_except_state : m_lock(&(object->m_lock))
{
...
modern_guard::modern_guard(volatile struct modern_class* const object) modern_except_state : m_lock(&(object->m_lock))
{
	while (m_lock->exchange(modern_guard_status::GUARD_STATUS_LOCKED, std::memory_order::memory_order_acquire) != modern_guard_status::GUARD_STATUS_FREE)
	{
		MODERN_GUARD_THROW
...
modern_guard::modern_guard(const struct modern_class* const object) modern_except_state : m_lock(&(object->m_lock))
{
	while (m_lock->exchange(modern_guard_status::GUARD_STATUS_LOCKED, std::memory_order::memory_order_acquire) != modern_guard_status::GUARD_STATUS_FREE)
	{
		MODERN_GUARD_THROW
...
modern_guard::modern_guard(struct std::atomic<int64_t>& lock) modern_except_state : m_lock(&lock)
{
	while (m_lock->exchange(modern_guard_status::GUARD_STATUS_LOCKED, std::memory_order::memory_order_acquire) != modern_guard_status::GUARD_STATUS_FREE)
	{
		MODERN_GUARD_THROW
