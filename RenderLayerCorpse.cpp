...
void RenderLayerCorpse::Push(GameObject* const object)
{
...
std::stack<class Tree*> _vectorcall RenderLayerCorpse::GetTreesBelow(class GameObject* const object, float range) modern_except_state
{
